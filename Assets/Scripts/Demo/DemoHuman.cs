...
public abstract class DemoHuman : MonoBehaviour
{
    ...
    {
        DemoAudioManager.Instance.PlayHumanSound();
    ...
    private void MoveToDestinationPoint()
    {
        ...
        if (hit.collider.TryGetComponent(out DemoHuman human) && human != this) return;
